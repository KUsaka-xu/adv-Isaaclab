...
parser.add_argument("--task", type=str, default="Attacker-Force-1", help="Name of the task.")
...
def main():
    ...
    #log_root_path = os.path.join( "scripts" ,"reinforcement_learning", "rsl_rl" ,"logs", "rsl_rl",agent_cfg.experiment_name)
