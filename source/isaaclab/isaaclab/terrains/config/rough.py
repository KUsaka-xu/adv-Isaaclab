...
#         ),
#         "boxes": terrain_gen.MeshRandomGridTerrainCfg(
#             proportion=0.0, grid_width=0.45, grid_height_range=(0.025, 0.1), platform_width=2.0
#         ),
#         "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
#             proportion=0.0, noise_range=(0.01, 0.06), noise_step=0.01, border_width=0.25
#         ),
#         "hf_pyramid_slope": terrain_gen.HfPyramidSlopedTerrainCfg(
